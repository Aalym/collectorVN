...
const scenes = {
    ...
    scene4: {
        ...
        name: "",
        char: girl,
        text: "Коридоры зловещего особняка не пугали девочку своим видом, хоть и свет есть только в избраных комнатах. Особняк гниёт и выглядит заброшенным, пол где-то проваливается, а где-то он целый. На самом деле ей он даже приглянулся...",
        bg: corridor,
        choices: [
    ...
    scenekitchen2: {
        ...
        name: "Девочка",
        char: girl,
        text: " Он ей совершенно не пользуется...Вот печаль, у него нет времени даже не еду.",
        bg: kitchen,
        choices: [
    ...
    sceneportrait3: {
        ...
        name: "Девочка",
        char: girl,
        text: "А может...он украл и их души?",
        bg: photo,
        choices: [
            { text: "Пойти в коридор.", next: "scenecorridor", type: "next" },
    ...
    scenebathroom: {
        ...
        name: "",
        char: girl,
        text: "Девочка осматривает ванную и заглядывает во все шкафчики в поисках зацепок и информации о загадочном Коллекционере .Она находит большое количество лекарств и различных антидепрессантов в тумбочках... ",
        bg: bathroom,
        choices: [
            { text: "Вернуться", next: "scenedoors2", type: "normal" },
    ...
    scenemagic2: {
        ...
        name: "Девочка",
        char: girl,
        text: " Это логично, раз него есть способность красть души... ",
        bg: lab,
        choices: [
    ...
    sceneghost: {
        id: "collector s3", 
        name: "Девочка",
        text: "Девочка отпирает дверь в комнату, от которой воняло смертью и отчаянием. За ней была стая десятков разложенных тел, ужас был неописуем. Любой бы на месте девочки убежал в страхе, но по какой-то причине та даже не дёрнулась. ",
    ...
    sceneghostlook2: {
        ...
        name: "Девочка",
        char: girl,
        text: ' Видимо вот, что осталось от всех тех, кто встретил его на своем пути.',
        bg: ghostroom,
        choices: [
    ...
    sceneghostlook3: {
        ...
        name: "Девочка",
        char: girl,
        text: ' Лишь оболочка, которая теперь странствует в поисках своих внутренностей...  ',
        bg: ghostroom,
        choices: [
    ...
    sceneghostlook5: {
        ...
        name: "",
        char: girl,
        text: ' Она оглядывается вниз и видит под своими ногами пыльный фонарик.',
        bg: ghostroom,
        choices: [
    ...
    sceneghostlook6: {
        ...
        bg: ghostroom,
        choices: [
        { text: "Дальше", next: "scenepodval", type: "normal"},
    ...
    id: "podval",
    name: "",
    text: "Героиня находит темную загадочную лестницу вниз.  Вероятнее всего, это был подвал.  Героиня сложила всю свою волю в кулак и направилась вниз по хрупким деревянным ступенькам, ожидая нечто страшное внизу...  ",
    bg: basementdoor,
    choices: [
    ...
    id: "podval",
    name: "Девочка",
    text: "(Это дочь Коллекционера? Она выглядит очень странно...Её лицо состоит из чужих душ. И это то, ради чего он их коллекционирует?)",
    char: girl, 
    bg: basement,
    choices: [
    ...
    scenecollectorAppears: {
        id: "escape",
        name: "Девочка",
        text: "(Коллекционер вернулся... Надо сбежать отсюда как можно скорее.)",
        char: girl,
        bg: basement,
        choices: [
    ...
    scenecollectorCatch3: {
        id: "escape",
        name: "Девочка",
        text: "Длинная фигура мужчины нависла над героиней, его взгляд был полон ярости. - Кто ты?! Что ты делаешь в моём доме и с моей дочерью?!",
        char: collectora,
        bg: black,
        choices: [
    ...
    sceneforest7: {
        id: "flashlight",
        name: "",
        text: "Девочка голыми руками разрывает лицо дочери. Холодная плоть в ладонях рассыпается на части, а пищащие бабочки беспомощно дёргаются. Она поглотила все эти души в себя...",
        char: null,
        bg: anotherEndingImg,
        choices: [
    ...
    id: "podval",
    name: "Девочка",
    text: "Теперь ты будешь моей душой и утолишь мою вечную пустоту… - Героиня хватает Коллекционера и использует его же машину против того. Раздался шум и звук разрывающейся плоти...Голубая бабочка полетела в её объятия - душа измученного Коллекционера. - Вот она...Наконец! Душа! ",
    char: girlh, 
    bg: black,
    choices: [
    ...
    id: "flash2",
    name: "",
    text: "Коллекционер от света фонаря громко падает на скрипящий пол. Раздался грохот. Она смогла выиграть для себя время, и девочка мигом выбегает из особняка Коллекционера.",
    char: collectora, 
    bg: black,
    choices: [
    ...
    id: "flash3",
    name: "Девочка",
    text: "Наконец-то…я не буду пустой оболочкой без души… - Шепчет она себе под нос и судорожно откручивает крышку от банки чтоб поскорее поглотить в себя бабочек.",
    char: girlh, 
    bg: forest,
    choices: [
